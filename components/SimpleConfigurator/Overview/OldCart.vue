...
defineProps<{ 
	selectedProducts: { indoorProducts: { neededQuantity: number; SelectedQuantity: number; products: any[]; }; outdoorProducts: { neededQuantity: number; SelectedQuantity: number; products: any[]; }; accessories: { quantity: number; products: any[]; }; controlUnit: { quantity: number; product: any; }; };
	product: any;
	controlUnit: { quantity: number; product: any; };
	total: number;
}>()
</script>
