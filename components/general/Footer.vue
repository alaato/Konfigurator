		...
		<div class="container mx-auto">
			<div class="grid grid-cols-2 md:grid-cols-4 gap-4">
				...
				<div>
					...
					<ul class="space-y-1">
						<li><a href="https://www.carus-concepts.com/" class="hover:underline">Carus-Concepts</a></li>
						<li><a href="https://www.tcs-entry.de/" class="hover:underline">TCS Entry</a></li>
						<li><a href="https://www.tcs-signage.de/" class="hover:underline">TCS Signage</a></li>
						<li><a href="https://www.dieversteckdose.de/" class="hover:underline">Die Versteckdose</a></li>
					</ul>
				</div>
				<div>
