...
<template>
  <StepperIndicator
    ...
    :class="cn(
      ...
      // Completed
      'group-data-[state=completed]:bg-black group-data-[state=completed]:text-neutral-900 dark:group-data-[state=completed]:bg-neutral-800 dark:group-data-[state=completed]:text-neutral-50',
      props.class,
    )"
  >
    <slot />
