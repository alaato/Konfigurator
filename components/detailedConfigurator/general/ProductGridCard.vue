<template>
	<Card
	            ...
	            @click="handleProductClick(product.node)"
	          >
	            <img  src="https://g-0f4zqqgpsyi.vusercontent.net/placeholder.svg?height=200&width=200" alt="Elegant Watch" class="w-full h-40 object-cover">
