<template>
    <section class="py-24 relative">
        <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
            ...
            <div v-for="product in productsSet" :key="product"
                ...
                <div
                    ...
                    <h3 class="img-box"><img :src="product?.cover.media.url " :alt="product?.name" class="xl:w-[140px]">
                    </h3>
                    <div class="pro-data w-full max-w-sm ">
                        ...
                        <p
                            ...
                            Art.-Nummer: {{ product?. productNumber}}
                        </p>
                    </div>
                </div>
                <div
                    ...
                    <h6
                        ...
                        {{getFormattedPrice(product?.calculatedPrice?.totalPrice) }}</h6>
                </div>
            </div>
...
<script setup>
const productSetStore = useProductsSet();
const { productsSet } = storeToRefs(productSetStore);
const { getFormattedPrice } = usePrice();
console.log(JSON.stringify(productsSet.value));
